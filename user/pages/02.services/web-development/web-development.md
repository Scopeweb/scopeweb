...
metadata:
    ...
    'og:title': Web Development | Scope Web
    'og:type': website
    ...
    'twitter:title' : Web Development Services | Scope Web
    'twitter:description' : Using JavaScript technologies like Vue and React, we create web apps that are both beautiful and lightning-fast. Our applications are modern, secure and forward-thinking.
